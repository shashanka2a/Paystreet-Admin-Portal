                      ...
                      <div className="flex items-center gap-3 mb-3">
                        <Badge
                          ...
                          className={`group-hover:scale-105 transition-transform duration-200 ${
                            log.status === 'success'
                              ? 'bg-green-100 text-green-900 dark:bg-green-800 dark:text-green-100 font-semibold'
                              : log.status === 'warning'
                              ? 'bg-orange-100 text-orange-900 dark:bg-orange-800 dark:text-orange-100 font-semibold'
                              : 'bg-blue-100 text-blue-900 dark:bg-blue-800 dark:text-blue-100 font-semibold'
                          }`}
                        >
                          {log.status}
                        </Badge>
