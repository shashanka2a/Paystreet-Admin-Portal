...
export function TopBar() {
  return (
    <div className="bg-black border-b border-[#38B000] px-8 py-4 flex items-center justify-between shadow-lg">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="flex items-center gap-3 hover:bg-[#1a1a1a] rounded-lg p-2 transition-colors">
            <Avatar className="w-9 h-9">
              <AvatarImage src="" />
              <AvatarFallback className="bg-[#38B000] text-black font-bold">
                AD
              </AvatarFallback>
            </Avatar>
          ...
          <DropdownMenuContent align="end" className="w-56 bg-black border border-[#38B000]">
            <DropdownMenuLabel className="text-white">My Account</DropdownMenuLabel>
            <DropdownMenuSeparator className="bg-[#38B000]" />
            ...
            <DropdownMenuSeparator className="bg-[#38B000]" />
            <DropdownMenuItem className="text-[#ef4444] hover:bg-[#1a1a1a]">Log out</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    </div>
